    ...
    render() {
        return (
            <div className={"home"}>
                ...
                <h4 className={"w3-center"}>These are a few of my personal<br/>interests when I am not busy writing code</h4>
                <h2>Sports</h2>
                <img className={"w3-image w3-right"} src="/img/los_angeles_lakers.png"/>
                <h3 className={"small-heading"}>NBA &#8210; Lakers</h3>
                    <p>I have a long-standing love for basketball. I don’t play as much as I used to, but I still watch the sport played at its highest level in the NBA. My
                    favorite team, the Los Angeles Lakers, also happen to be the best team as far as most playoff appearances (60), most NBA Finals appearances (31), 2nd most
                    hall of famers (23), 2nd most championships (16), and 2nd most regular season MVPs (8). They won their last championship in 2010 and haven’t been to the
                    playoffs since 2013, but with youthful talent, quality coaching and management it shouldn’t be too long before we return. (<em>All numbers as of 7/2017</em>)</p>
                ...
                <h3>Georgia Tech College Football</h3>
                    ...
                    <p>I grew to like football over the years as a kid. I never really played much except out in the street in the neighborhood. Watching it on TV and playing the
                    game in video games was usually pretty exciting. It was not until I went to college that I got the thrill of seeing football played at a high level in person
                    (high school doesn’t count). While at Georgia Tech I got to see Calvin Johnson, Demaryius Thomas, Morgan Burnett and whole host of other great Tech players
                    don the white and old gold. I also got to see players such as Matt Ryan, Matt Stafford, A.J. Green and C.J. Spiller line up against us. The passion from the
                    fans seen in a college game is great experience and their isn’t much that rivals cheering for your alma mater.</p>
                ...
                <div className={"w3-padding-small w3-right w3-center w3-margin mario"}>
                <img className={"w3-image"} src="/img/mario.jpg"/>
                </div>
                    <p className={"w3-margin"}>In my younger years I played many games going all the way back to the Atari. Platformers (Mario Bros., Sonic), Fighters (Street Fighter, Mortal Kombat),
