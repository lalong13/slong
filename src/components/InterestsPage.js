        ...
        return (
            <div className="home">
                <div className="w3-margin">
                    ...
                    <h4 className="w3-center">I wanted to share a few of my personal interests<br/>when I am not busy writing code</h4>
                    <h2>Sports</h2>
                    ...
                    <h2>Video Games</h2>
                        <img className="w3-margin w3-image w3-right" src="/img/xbox.jpg"/>
                        <h3>XBox</h3>
                        ...
                        <img className="w3-image w3-left" src="/img/sonic05_32.png"/>
                        <img className="w3-image w3-center w3-margin" src="/img/mario.jpg"/>
