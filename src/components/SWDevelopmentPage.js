                ...
                <div className="w3-margin">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p>I personally don&#39t like Java that much as it is highly verbose and is very complicated to get many little things done. I understand it
                    ...
                    <div>
                        ...
                        <div>
                            <p>I, not so secretly anymore, really love C. I haven&#39t coded in it in years however as its downsides have seem to regulate it mostly to the
                            ...
                            do many of the basic things that we write code to accomplish. I haven&#39t used C++ as much as C but with C#, Objective-C and Java, the need for
                            C and C++ isn&#39t anywhere near what it used to be.</p>
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            <h3>Perl</h3>
                            <p>Let&#39s not talk about it... Seriously though, Perl is a great scripting language especially for all things regular expressions. It has some
                    ...
                    <div>
                        ...
                        <div>
                            <p>Although it looks a lot like Perl, it is better is almost everyway, especially if you aren&#39t trying to modify text files. It is fairly slow
                            running and doesn&#39t scale all that well on its own. (Facebook developed a virtually machine for PHP. They have since moved away from base PHP).
                    ...
                    <div className="w3-display-container">
                        ...
                        <p>I can&#39t really speak to Angular too much yet, as that will probably be a future project. I can speak to React and the framework/libraries that
                    ...
                    <div>
                        ...
                        <div>
                            <p>Ruby is a very interesting language that with Rails can allow a developer to build a website very quickly. I&#39m not sure if it will maintain it&#39s
                    ...
                    <div>
                        ...
                        <div>
                            <p>Python is a language that is very similar to Perl in utility, but probably better in every way except for regular expressions. I&#39m not well-versed
